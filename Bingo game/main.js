...
function GenerateToNewCard() {
    ...
    for (var i = 0; i < 25; i++) {
        ...
        GenerateIntoTheSquare(i);
    }
}

function GenerateIntoTheSquare(squareNum) {
    ...
    newNumber = (baseNumbers[squareNum] * 15) + GenerateNewNmber();
...
// when clicked, replace to a new random card
function ReplaceToNewCard() {
    ResetUsedNumbers();
    GenerateToNewCard();
    resetSquareColours();
}
